            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <select name="agama" Size="1" class="form-control form-control-user">        
                        <option value ="Islam" id="agama"> Islam </option>        
                        <option value ="Kristen" id="agama"> Kristen </option>
                        <option value ="Hindu" id="agama"> Hindu </option>
                        <option value ="Budha" id="agama"> Budha </option>
                        <option value ="Konghucu" id="agama">Konghucu </option> 
                        </select>
                  </div>
                  <div class="form-group">
