...
if(isset($_POST['daftar'])) {
    ...
    if($lokasiFoto=="" || $lokasiSertif=="") { 
        ...
        $sql= "INSERT INTO dokter VALUES ('$id_dokter','$nama','$email','$jk','$alamat','$tempat','$telpon','$fp','$sertif','$jabatan','$jadwal_kerja','$username','$password','$verifikasi')";
        if(mysqli_query($koneksi,$sql)){
            ...
            header("location:index.php?pesan=cek-foto");
    }
} }
?>
