		...
		<?php include "navbar.php" ?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Data Respon Konsultasi</h1>
						</div>
					...
					if(isset($_POST['tambah'])){
						...
						if ($jumlah_data >= 1 ) {
							...
							$sql = "INSERT INTO respon_konsultasi VALUES ('$id_respon','$id_dokter','$respon','$tanggal_respon')";
					...
					if(isset($_POST['edit'])){
						//edit
						$sql = "UPDATE respon_konsultasi SET  id_dokter = '$id_dokter' , respon = '$respon' , tanggal_respon = '$tanggal_respon'WHERE id_respon = '$id_respon'";
						if(mysqli_query($koneksi, $sql)){
					...
					if(isset($_POST['delete'])){
						//delete
						$sql = "DELETE FROM respon_konsultasi WHERE id_respon = '$id_respon'";
						if(mysqli_query($koneksi, $sql)){
					...
					if(isset($_POST['deleteall']))
					{
						//delete
						$pilih = $_POST['pilih'];
							$sql = "DELETE FROM respon_konsultasi WHERE id_respon IN (".implode(",", $pilih).")";
							if(mysqli_query($koneksi, $sql))
							{
								$nilaihasil = "Records deleted successfully.";
							} 
        ...
        <div class="table-wrapper">
            ...
            <table id="tabel-data" class="table table-striped table-hover" >
                ...
                <tbody>
					<?php
					$i = 1;
					$ksql="SELECT * FROM respon_konsultasi";
					...
					<tr>
						<td>
							<span class="custom-checkbox">
								<input type="checkbox" id="checkbox5" name="pilih[]" value="<?php echo $krow['id_respon']; ?>">
                        ...
                        <td>
                            ...
                            <a href="#deleteEmployeeModal<?php echo $krow['id_respon']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
					...
					<!-- Delete Modal HTML -->
					<div id="deleteEmployeeModal<?php echo $krow['id_respon']; ?>" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
							<form method="post" action="">
								<input type="text" class="form-control" value="<?php echo $krow['id_respon']; ?>" name="id_respon" required>
									<div class="modal-header">
						...
						<div class="modal-dialog">
							...
							<form role="form" method="POST" action="">
									...
									<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Respon :</label>
                                            <input type="date" name="tanggal_respon" id="tanggal_respon" class="form-control" >
                                        </div>
