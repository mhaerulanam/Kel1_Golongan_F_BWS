          ...
          <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-item-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Hitung Diskon</h6>
        ...
        <div id="main">
            ...
            <form method="POST" action="">                
                <table>
                    <tr>
                        <td>Masukan Harga</td>
                        <td><input type="text" id="bil1" name="bil1" required/></td>
                    </tr>
                    <tr>
                        <td>Masukan Diskon (Tanpa Tanda %)</td>
                        <td><input type="text" id="bil2" name="bil2" required/></td>
                    </tr>
                    <tr>
                        <td>
                        <label><br><br>
            ...
            <div id="hasil">
                <?php
                    ...
                    function diskon($diskon,$harga) {
                       ...
                       echo "Anda Mendapat Potongan Harga:".$potongan."<br>";
                    }
