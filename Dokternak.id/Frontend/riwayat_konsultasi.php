      ...
      <div class="inbox_msg">
        <div class="inbox_people inbox2">
          ...
          <div class="inbox_chat">
            ...
            <?php
            $id = $_SESSION['id'];
            $RData=mysqli_query($koneksi, "SELECT * FROM konsultasi, peternak, dokter WHERE konsultasi.id_peternak=peternak.id_peternak AND konsultasi.id_dokter=dokter.id_dokter AND konsultasi.id_peternak='$id' AND status_kirim='norespon' ORDER by tanggal DESC, id_konsultasi DESC");
