            ...
            <div class="card shadow mb-4">
              ...
              <form method="post" >
                    <div class="form-group">
                        <input type="text" name="nim" id="nm" class="form-control form-control-user" placeholder="NIM" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="namamahasiswa" id="nma" class="form-control form-control-user" placeholder="Nama Mahasiswa" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="alamt" id="almt" class="form-control form-control-user" placeholder="Alamat" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="usia" id="usa" class="form-control form-control-user" placeholder="Usia">
                    </div>
                    <div class="form-group">
                        <input type="date" name="tanggallahir" id="tgl" class="form-control form-control-user" placeholder="Tanggal Lahir">
                    </div>
                    <div class="form-group">
                  ...
                  if($nama){
                    echo "<strong>Nama Mahasiswa: </strong> {$nama} <br>";
                  }
                  ...
                  if($usia){
                    echo "<strong>Usia: </strong> {$usia} <br>";
                  }
                  ...
                  $result = mysqli_query($koneksi,"INSERT INTO tbl_mahasiswa VALUES('$nim','$nama','$alamat','$usia','$tgllahir','$jk','$agama')"); 
