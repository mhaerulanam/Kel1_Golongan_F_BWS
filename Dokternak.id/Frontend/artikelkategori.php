                    ...
                    <div class="btn_tulis">
                        ...
                        <aside class="single_sidebar_widget search_widget">
                                <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder='cari artikel' name="nt" id="cari artikel" autocomplete="off" value="<?php echo $search_keyword; ?>"
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'search_keyword'">
                                        <div class="input-group-append">
                                            <button class="btns" type="submit" value="submit" name="submit"><i class="ti-search"></i></button>            
                                        </div>
                                   
                                <div class="select-form" method = "post">
                                        <div class="select-itms">

                                        <select name="kategori_artikel" class="form-control" id="exampleFormControlSelect1">
                                        <option value="">Pilih Kategori</option>
                                        <option name="Kucing">Kucing</option>
                                        <option name="Kambing">Kambing</option>
                                        <?php
                                        if (isset($_POST['Kucing'])) {
                                            $submit = $_POST['txtsearch'];
                                            $kategori_artikel = $_POST['kategori_artikel'];
                                            
                                            $sql = "SELECT * FROM kategori_artikel WHERE kategori_artikel LIKE '%$search%'";
                                            $result = mysql_query($sql) or die('Error, list artikel failed. ' . mysql_error());
                                            ...
                                            if (mysql_num_rows($result) == 0) {
                                             ...
                                             while ($row = mysql_fetch_array($result)) {
                                              ...
                                              echo '<p>Id Kategori: '.$id_ktg.'</p>';
                                              echo '<p>Kategori Artikel: '.$kategori_artikel.'</p>';
                                              echo '<p></p>';
                                             }
                                            }
                                           }
