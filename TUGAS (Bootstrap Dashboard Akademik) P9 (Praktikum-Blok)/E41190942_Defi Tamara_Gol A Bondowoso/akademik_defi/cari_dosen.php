          ...
          <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-item-center justify-content-between">
                <a class="m-0 font-weight-bold text-primary" href="data_dosen.php"> <= Kembali</a>
              ...
              <div class="card-body">
               ...
               <?php 
                ...
                <form class="form-inline mr-auto w-100 navbar-search" action="cari_dosen.php">
                ...
                <form action="cari-dosen.php" method="get">
                <!-- <label>Cari :</label>
                ...
                if(isset($_GET['cari'])){
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi,"select * from dosen where nama like '%".$cari."%'");    
                }else{
